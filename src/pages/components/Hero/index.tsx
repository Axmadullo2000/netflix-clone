...
function Hero({trending}: HeroProps) {
    ...
    return (
        <div className={'flex flex-col ml-10 mt-5  space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:pb-12 lg:justify-end'}>
            ...
            <button className={'flex justify-center items-center gap-2 bg-red-600 hover:bg-red-500 font-bold text-slate-100 w-[250px] h-[60px] rounded-full text-xl transition-colors duration-500'}>
                <GrPlay className={'w-6 h-6'} color={'white'} />
                Watch Now
            </button>
        </div>
    )
